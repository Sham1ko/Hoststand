...
Основной источник данных — версионированное состояние в `localStorage` с ключом `qolay.restaurant.v1`. При отсутствии или повреждении сохранённых данных приложение восстанавливает seed: три этажа, шесть зон, 24 стола и 15 броней.
